...
!function () {
    ...
    a.modules = {}, a.aliases = {}, a.resolve = function (b) {
        ...
        (function () {
            ...
            d = "undefined" != typeof Emitter && null !== Emitter ? Emitter : b("emitter"), g = function () {
                ...
                return j(b, a), b.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "selectedfiles", "addedfile", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded"], b.prototype.defaultOptions = {
                    ...
                    addedfile: function (a) {
                        ...
                        for (a.previewElement = b.createElement(this.options.previewTemplate.trim()), a.previewTemplate = a.previewElement, this.previewsContainer.appendChild(a.previewElement), h = a.previewElement.querySelectorAll("[data-dz-name]"), d = 0, f = h.length; f > d; d++)c = h[d], c.textContent = a.name;
                        for (i = a.previewElement.querySelectorAll("[data-dz-size]"), e = 0, g = i.length; g > e; e++)c = i[e], c.innerHTML = this.filesize(a.size);
                        return this.options.addRemoveLinks && (a._removeLink = b.createElement('<a class="dz-remove" href="javascript:undefined;">' + this.options.dictRemoveFile + "</a>"), a._removeLink.addEventListener("click", function (c) {
                            return c.preventDefault(), c.stopPropagation(), a.status === b.UPLOADING ? b.confirm(j.options.dictCancelUploadConfirmation, function () {
                                return j.removeFile(a)
                            }) : j.options.dictRemoveFileConfirmation ? b.confirm(j.options.dictRemoveFileConfirmation, function () {
                                return j.removeFile(a)
                            }) : j.removeFile(a)
                    ...
                    error: function (a, b) {
                        var c, d, e, f, g;
                        for (a.previewElement.classList.add("dz-error"), f = a.previewElement.querySelectorAll("[data-dz-errormessage]"), g = [], d = 0, e = f.length; e > d; d++)c = f[d], g.push(c.textContent = b);
                        return g
                    },
                    errormultiple: g,
            ...
            }(d), a.version = "3.7.3", a.options = {}, a.optionsForElement = function (b) {
