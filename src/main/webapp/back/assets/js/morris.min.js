...
(function () {
    ...
    t = window.Morris = {}, e = jQuery, t.EventEmitter = function () {
        ...
        return o(n, e), n.prototype.init = function () {
            ...
            if (this.options.hideHover !== "always")return this.hover = new t.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick)
        ...
        var r;
        return o(i, n), r = {fillOpacity: "auto", behaveLikeLine: !1}, i.prototype.calcPoints = function () {
            var e, t, n, r, i, s, o;
            s = this.data, o = [];
